...
image_folder = os.path.join(base_dir, "img/ground_breaking/originals")
processed_folder = os.path.join(base_dir, "img/ground_breaking/processed")
metadata_file = os.path.join(base_dir, "img/ground_breaking/metadata.json")
    ...
    try:
        ...
        if points and current_image is not None:
            ...
            if len(percentage_points) == 2:
                ...
                percentage_points[0][1] = 0.0
                percentage_points[1][1] = 1.0
        
        # Create the metadata entry with percentage-based points
        image_entry = {
            "path": f"img/ground_breaking/processed/{clean_name}",
